...
> Source: **Azure VM Compare Investigation Guide** dashboard, chapter **VM IO Histogram Stats** (2 queries across 2 sub-groups).

Each KQL block is preserved verbatim from the dashboard. Substitute params (`{globalFrom}`, `{nodeId}`, etc.) with case values, then execute via vm-kusto-query / kusto_runner.py / replay.py.

---

## HostStorage IO Stats Summary for {{containerId1}}

### Azure Host VM StorageClient IO Latency Stats

_Widget purpose:_ HostStorage IO Stats Summary for {{containerId1}}

Cluster: `storageclient.eastus.kusto.windows.net` · Database: `Fa` · Type: `Table`
Source panel: `VM IO Histogram Stats > HostStorage IO Stats Summary for {{containerId1}}`

> ⚠️ Verbose machine-generated KQL (73 KB, e.g. histogram aggregations expanded across many bins). Full body extracted to [`07-vm-io-histogram-stats--azure-host-vm-storageclient-io-latency-stats.kql`](07-vm-io-histogram-stats--azure-host-vm-storageclient-io-latency-stats.kql); the opening lines are shown below for context. Nothing is truncated — the full query is preserved verbatim in the `.kql` file.
...
// ... [truncated — see 07-vm-io-histogram-stats--azure-host-vm-storageclient-io-latency-stats.kql for full body]
```
...
## HostStorage IO Stats Summary for {{containerId2}}

### Azure Host VM StorageClient IO Latency Stats

_Widget purpose:_ HostStorage IO Stats Summary for {{containerId2}}

Cluster: `storageclient.eastus.kusto.windows.net` · Database: `Fa` · Type: `Table`
Source panel: `VM IO Histogram Stats > HostStorage IO Stats Summary for {{containerId2}}`
