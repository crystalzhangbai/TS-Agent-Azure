...
> Source: **NRP - Resource Groups** dashboard, chapter **(top-level)** (2 queries across 1 sub-groups).
...
| project subscriptionId = local_subscriptionId, resourceGroupName = local_resourceGroupName
```
