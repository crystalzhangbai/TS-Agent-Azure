...
> Source: **ARM Activity Ids Investigation Guide** dashboard, chapter **Errors** (1 queries across 1 sub-groups).
...
(
    union X.database('Traces').Errors, X.database('Jobs').JobErrors
