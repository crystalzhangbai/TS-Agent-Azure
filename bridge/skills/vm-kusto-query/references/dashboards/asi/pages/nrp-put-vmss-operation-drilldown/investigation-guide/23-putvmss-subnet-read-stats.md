...
> Source: **NRP - PUT VMScaleSet Operation drill down** dashboard, chapter **PutVmss Subnet read stats** (1 queries across 1 sub-groups).
...
### PutVmssSubnetReadStats

_Widget purpose:_ PutVmss Subnet read stats

Cluster: `nrp.kusto.windows.net` · Database: `mdsnrp` · Type: `TimeSeries`
Source panel: `PutVmss Subnet read stats`
