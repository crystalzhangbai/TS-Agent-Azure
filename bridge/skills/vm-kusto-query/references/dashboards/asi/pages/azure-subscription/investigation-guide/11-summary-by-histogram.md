...
> Source: **Azure Subscription Investigation Guide** dashboard, chapter **Summary by Histogram** (1 queries across 1 sub-groups).
...
### Azure Host Subscription AIR-BP by Histogram

_Widget purpose:_ Summary

Cluster: `rdosdata` · Database: `rdosdatapath` · Type: `Table`
Source panel: `Summary by Histogram > Summary`
...
by HistogramDesc = GetHistogramDesc(HistogramTypeEnum)
```
