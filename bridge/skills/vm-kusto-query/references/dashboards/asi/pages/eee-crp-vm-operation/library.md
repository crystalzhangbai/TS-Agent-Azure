# EEE CRP — VM Operation: KQL Query Library

> Auto-extracted from ASI on 2026-05-13T08:36:00.437Z.
> Total: 18 unique KQL queries across 16 panels (19 widget refs).
...
### Resource Operations > Subscription Operations > Subscription Operations > CRP > CRP > CRP Operations Timeline for Subscription
Path: `Resource Operations > Subscription Operations > Subscription Operations > CRP > CRP > CRP Operations Timeline for Subscription`  ·  Queries: 1

| # | Name | Type | Cluster | Database | Params |
|---|------|------|---------|----------|--------|
| 1 | CRP Operation Table | Timeline | azcrp | crp_allprod | starttime, endtime, subscriptionid |
...
| # | Name | Type | Cluster | Database | Params |
|---|------|------|---------|----------|--------|
| 1 | Component Call | Timeline | azcrp | crp_allprod | starttime, endtime, operationid |
