...
> Source: **CRP OperationId Investigation Guide** dashboard, chapter **Allocation Activity** (1 queries across 1 sub-groups).
...
Source panel: `Allocation Activity > Allocation Activity > Compute Allocation Activity`
